...
def main(
    ...
    Examples:
    make_monomer.py tests/pdbs/2XQS_short.pdb tmp/ --generator-steps=25 --linker-lengths=15 --num-designs=5
    make_monomer.py tests/pdbs/2XQS_short.pdb tmp/ --generator-steps=10 --linker-lengths=10-20 --num-designs=3
    make_monomer.py tests/pdbs/4JPP_short.pdb tmp/ --generator-steps=15 --linker-lengths=30 --num-designs=1
    """
